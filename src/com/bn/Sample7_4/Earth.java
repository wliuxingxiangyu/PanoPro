...
//	int uNightTexHandle;// 黑夜纹理属性引用id
	...
	public void initVertexData(float r) {
		...
		final float angleSpan = 1f;// 将球进行单位切分的角度//原为10.0f
	...
	public void drawSelf(int texId) {
		...
		(maNormalHandle, 4, GLES20.GL_FLOAT, false, 3 * 4, mVertexBuffer);
		// 允许顶点位置数据数组
		...
		GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, texId);// 白天纹理
		// GLES20.glActiveTexture(GLES20.GL_TEXTURE1);
		// GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, texIdNight); //黑夜纹理
